...
def agregar():
    tomate = num.get()
    comprado6 = tomate*4.7
    compra6 = open("compras.txt","a")
    compra6.write("Tomates: {}\n".format(comprado6))
...
def forward():
    root.destroy()
    call(["python", "productos7.py"])

#boton atras
def back():
    root.destroy()
    call(["python", "productos5.py"])
...
#imagen
imagen = PhotoImage(file="img/tomate.gif")
...
#producto
producto = Label(root,text="TOMATE : S/.4.70 c/u ",font=("Sans Serif",20), fg="red")
