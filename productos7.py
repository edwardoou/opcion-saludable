...
def agregar():
    limon = num.get()
    comprado7 = limon*1.4
    compra7 = open("compras.txt","a")
    compra7.write("Limones: {}\n".format(comprado7))
...
#imagen
imagen = PhotoImage(file="img/limon.gif")
...
#producto
producto = Label(root,text="LIMON : S/.1.40 c/u ",font=("Sans Serif",20), fg="red")
