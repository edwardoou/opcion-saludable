...
def agregar():
    papaya = num.get()
    comprado5 = papaya*3.4
    compra5 = open("compras.txt","a")
    compra5.write("Papayas: {}\n".format(comprado5))
...
#imagen
imagen = PhotoImage(file="img/papaya.gif")
...
#producto
producto = Label(root,text="PAPAYA : S/.3.40 c/u ",font=("Sans Serif",20), fg="red")
