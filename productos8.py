...
def agregar():
    pepino = num.get()
    comprado8 = pepino*2.0
    compra8 = open("compras.txt","a")
    compra8.write("Pepinos: {}\n".format(comprado8))
...
#imagen
imagen = PhotoImage(file="img/pepino.gif")
...
#producto
producto = Label(root,text="PEPINO : S/.2.00 c/u ",font=("Sans Serif",20), fg="red")
