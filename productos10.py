...
def agregar():
    zanahoria = num.get()
    comprado10 = zanahoria*3.5
    compra10 = open("compras.txt","a")
    compra10.write("Zanahorias: {}\n".format(comprado10))
...
#imagen
imagen = PhotoImage(file="img/zanahoria.gif")
...
#producto
producto = Label(root,text="ZANAHORIA : S/.3.50 c/u ",font=("Sans Serif",20), fg="red")
