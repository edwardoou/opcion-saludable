...
def agregar():
    durazno = num.get()
    comprado9 = durazno*4.3
    compra9 = open("compras.txt","a")
    compra9.write("Duraznos: {}\n".format(comprado9))
...
def forward():
    root.destroy()
    call(["python", "productos10.py"])

#boton atras
def back():
    root.destroy()
    call(["python", "productos8.py"])
...
#imagen
imagen = PhotoImage(file="img/durazno.gif")
...
#producto
producto = Label(root,text="DURAZNO : S/.4.30 c/u ",font=("Sans Serif",20), fg="red")
