...
def agregar():
    manzana = num.get()
    comprado1 = manzana*2.5
    compra1 = open("compras.txt","a")
    compra1.write("Manzanas: {}\n".format(comprado1))
...
#imagen
imagen = PhotoImage(file="img/manzanas.gif")
...
#producto
producto = Label(root,text="MANZANAS : S/.2.50 c/u ",font=("Sans Serif",20), fg="red")
